...
//    < li > < a ui - sref = "app.quakes" > < i class = "fa fa-bullseye fa-fw" > < /i> Earthquakes Map Explorer</a > < /li> < li class = "disabled" > < a ui - sref = "app.none" > Clock Tools(alarm, stopwatch) < /a></li >
